...
<!--      _____                   _______                   _____                    _____                    _____          
    ...
    /:::/|::|   |           /:::/    \:::\    \       /:::/|::|   |            /:::/____/               /:::/__\:::\    \    
   /:::/ |::|   |          /:::/    / \:::\    \     /:::/ |::|   |           /::::\    \               \:::\   \:::\    \   
  /:::/  |::|___|______   /:::/____/   \:::\____\   /:::/  |::|   | _____    /::::::\____\________    ___\:::\   \:::\    \  
 /:::/   |::::::::\    \ |:::|    |     |:::|    | /:::/   |::|   |/\    \  /:::/\:::::::::::\    \  /\   \:::\   \:::\    \ 
 ...
 \/____/      /:::/    /   \:::\    \ /:::/    /   \/____/ |::| /:::/    /  \/____|::|   |           \:::\   \:::\   \/____/ 
        ...
        \::/    /                 ~~                      \::/    /                \:|   |                  \::/    /        
         \/____/                                           \/____/                  \|___|                   \/____/         
                                                                    ...
                                                                    This website was lovingly typed by Andrew Monks
                                                                                                    http://monks.co
                                                                                                         a@monks.co  -->
...
<!--				FOURTH COLUMN -->
				    ...
				    <?php
				    	...
				    	$request_url = "http://api.soundcloud.com/users/6816129/favorites.json?client_id=9a94fbeffc0453daee14d414f2981c8f";
				    	$json = file_get_contents($request_url);
				    	$array = json_decode($json, TRUE);
				    	$latest_sc_favorite_id = $array[0]['id'];
				    	$latest_sc_favorite_name = $array[0]['title'];
				    	echo 	'<div class="grid_3">
								<div class="white title">'.$latest_sc_favorite_name.'</div>
						    	<iframe width="100%" height="166" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=http%3A%2F%2Fapi.soundcloud.com%2Ftracks%2F'.$latest_sc_favorite_id.'"></iframe>';
		...
		<div id="bottom">
			<div class="container_12">
				<div class="space">
					<p><a href="http://greeenha.us">GREEENHAU$</a> | 3316 N. Halsted Street, 3rd Floor | Chicago, IL 60657</p>
				</div>
				<div class="space">
